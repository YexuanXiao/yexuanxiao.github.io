...
categories: [blog]
---
本文是我在知乎上的[回答](https://www.zhihu.com/question/266995763/answer/2765466772)的拷贝，指出 C 和 C++ 的发展不是孤立的，C89 在事实上采纳了 C++ 方言而取代了原本的 K&R 方言，并且未来的 C 标准也一直从 C++ 中吸收新特性，因此 C++ 实际上已经取代了 C （K&R 版）并持续作为标准 C 的蓝图。
...
C 语言从 C89 开始就已经存在着非常强烈的从 C++ 吸收特性的趋势，Linus 最近批准 Linux 使用 C11，目的是为了引入 for 声明（C99 加入），而这个特性在 1980s 就出现在 C++ 中了。
