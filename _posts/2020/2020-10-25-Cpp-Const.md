...
　　这就相当与定义char *p1 = "hello"，char *p1 = "world"，char *p3 = "string1"， char *p4 = "string2"，这是四个指针，每个指针存放一个字符串首地址，然后用arr[4]这个数组分别存放这四个指针，就形成了指针数组。
...
https://www.dyxmq.cn/program/code/c-cpp/cpp-const-4-top-level-const-and-low-level-const.html
