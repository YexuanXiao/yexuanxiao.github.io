...
categories: [blog]
---
　　之前买了西数的 SN550 NVMe 固态硬盘 和 绿联的 C400 硬盘盒，给 Surface Book 3 补充一下空间。 
...
由于主控原因，SN 550 只支持最大 1TB 容量，而闪迪正好可以生产单颗粒 1TB，所以为了和 0.5TB 共用 PCB，闪迪直接放了一颗　１TB　的颗粒。

和老款　SN 500 不同的是，新款的 PCB 没有和主控芯片在一起。以往老款 SN500 可以通过锯断的方式变成小规格的，这次不可以。另外三星也有一款和 SN500 近似设计的硬盘，但是有布线在“占位”，不能锯断。
...
在使用时，如果没插好，可能会造成降速情况，比如这样：

![20201102114612](https://tvax2.sinaimg.cn/large/005ZJ4a1gy1gkawyrg45ej31jo0u9qex.jpg)